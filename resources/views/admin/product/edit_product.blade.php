                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input id="details" name="details" value="{{ $product->details }}" value="{{ $product->details }}"  type="text" class="form-control" required>
                                @error('details')
                                <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input id="price" name="price" value="{{ $product->price }}" type="number" step="0.01" class="form-control"
                                    required>
                                @error('price')
                                <div class="text-danger small">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input id="discount_price" name="discount_price" value="{{ $product->discount_price }}" type="number" step="0.01"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input id="quantity" name="quantity" value="{{ $product->quantity }}" type="number" class="form-control" required>
                                @error('quantity')
                                <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-md-6 col-lg-4">
                            <div class="mb-3">
                                ...
                                <input id="barcode" name="barcode" value="{{ $product->barcode }}" type="text" class="form-control" required>
                                @error('barcode')
                                <div class="text-danger small">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="product_description" name="product_description" value="{{ $product->details }}" rows="6"
